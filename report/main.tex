...
\resizebox{\textwidth}{!}{%
\begin{tabular}{lllll}
Patch size & Comments & \begin{tabular}[c]{@{}l@{}}Training set\\ (pictures per class)\end{tabular} & Test set(pictures per class) & Correct guess \\
$8*8$ & Dataset contains handwritten characters. 
Using characters +,-,/,= as operators & 3 & 3 & 64\% \\
$8*8$ & Dataset contains handwritten characters. 
Using characters +,-,/,= as operators. & 52 (7 for operators) & 3 & 66\% \\
$8*8$ & Dataset contains computer fonts. 
Using characters +,-,/,= as operators. & 1013 (7 for operators) & 3 & 66\% \\
$8*8$ & Dataset contains computer fonts. 
Using characters A,S,D,E as operators. & 916 & 100 & 91\% \\
$16*16$ & Dataset contains handwritten characters. 
Using characters +,-,/,= as operators. & 3 & 3 & 89\% \\
$16*16$ & Dataset contains handwritten characters. 
Using characters +,-,/,= as operators. & 52 (7 for operators) & 3 & 85\% \\
$16*16$ & Dataset contains computer fonts. 
Using characters +,-,/,= as operators. & 1013 (7 for operators) & 3 & 62\% \\
$16*16$ & Dataset contains computer fonts. 
Using characters A,S,D,E as operators. & 916 & 100 & 96\% \\
$32*32$ & Dataset contains handwritten characters. 
Using characters +,-,/,= as operators. & 3 & 3 & 81\% \\
$32*32$ & Dataset contains handwritten characters. 
Using characters +,-,/,= as operators. & 52 (7 for operators) & 3 & 89\% \\
$32*32$ & Dataset contains computer fonts. 
Using characters +,-,/,= as operators. & 1013 (7 for operators) & 3 & 77\% \\
$32*32$ & Dataset contains computer fonts. 
Using characters A,S,D,E as operators. & 916 & 100 & 98(
\end{tabular}%
}
